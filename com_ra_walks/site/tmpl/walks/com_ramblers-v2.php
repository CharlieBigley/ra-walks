...
FormHelper::addFieldPath(JPATH_COMPONENT_ADMINISTRATOR . '/src/field');
...
/*
  $days = FormHelper::loadFieldType('dow');
...
$walks_follow = false;
$target_info = "index.php?option=com_ra_walks&view=walk&callback=walks&id=";
if ($walks_follow) {
