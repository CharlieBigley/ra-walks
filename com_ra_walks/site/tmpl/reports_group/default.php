...
echo "<h2>" . 'Group=' . $this->group_code . ' ' . $group_name . "</h2>";
?>
...
$target = "index.php?option=com_ra_walks&view=reports_group&group_code=" . $this->group_code;
